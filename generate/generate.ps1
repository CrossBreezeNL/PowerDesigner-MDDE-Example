...
cmd /c $XgGenCmd -cll INFO -c .\XGenAppConfig.xml `
    ...
    -mtc "../models/decomposed/MDDE_Example/MDDE_Example.xml::Database_Code/Database/Database_Code.sqlproj::DatabaseXmlConfig.xml" `
    -mtc "../models/decomposed/MDDE_Example/MDDE_Example.xml::Database_Code/Database/Schema_Code/Schema_Code.sql::SchemaTextConfig.xml" `
    -mtc "../models/decomposed/MDDE_Example/MDDE_Example.xml::Database_Code/Database/Schema_Code/Tables/Table_Code.sql::TableTextConfig.xml"